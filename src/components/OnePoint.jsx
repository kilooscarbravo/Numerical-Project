...
const OnePoint =()=>{
    ...
    const calculateRoot = () =>{
        ...
        // const Equationnum = parseFloat(Equation)
        // CalOnePoint(XStartnum,Equationnum);
...
//   const CalOnePoint = (XStart, Equation) => {
//     var X, ea, scope;
//     var iter = 0;
//     var MAX = 50;
//     const e = 0.00001;
...
//   const calculateRoot = () => {
//     const xStartNum = parseFloat(XStart);
//     CalOnePoint(xStartNum, Equation);
...
//         </Form>
//         <br></br>
//         <h5>Answer X = {valueX[valueX.length - 1].toPrecision(7)}</h5>
